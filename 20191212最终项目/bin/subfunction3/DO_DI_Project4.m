function varargout = DO_DI_Project4(varargin)
% DO_DI_PROJECT4 MATLAB code for DO_DI_Project4.fig
%      DO_DI_PROJECT4, by itself, creates a new DO_DI_PROJECT4 or raises the existing
%      singleton*.
%
%      H = DO_DI_PROJECT4 returns the handle to a new DO_DI_PROJECT4 or the handle to
%      the existing singleton*.
%
%      DO_DI_PROJECT4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DO_DI_PROJECT4.M with the given input arguments.
%
%      DO_DI_PROJECT4('Property','Value',...) creates a new DO_DI_PROJECT4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DO_DI_Project4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DO_DI_Project4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DO_DI_Project4

% Last Modified by GUIDE v2.5 19-Dec-2019 15:29:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DO_DI_Project4_OpeningFcn, ...
                   'gui_OutputFcn',  @DO_DI_Project4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DO_DI_Project4 is made visible.
function DO_DI_Project4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DO_DI_Project4 (see VARARGIN)

% Choose default command line output for DO_DI_Project4
...
% UIWAIT makes DO_DI_Project4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DO_DI_Project4_OutputFcn(hObject, eventdata, handles) 
