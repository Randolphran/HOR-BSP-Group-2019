...
int main(int argc, char* argv[])
{
   ...
   do 
   {
      ...
      ret = UdCounterCtrl_CompareSetTable(udCounterCtrl, channelStart, 3, &comValueTab[0][0]);
      CHK_RESULT(ret);
...
void BDAQCALL OnUdCntrEvent(void * sender, UdCntrEventArgs * args, void *userParam)
{
   ...
   if (evntID[channel] == args->Id)
   {
      ...
      tabIndex++;
      UdCounterCtrl_CompareSetTable(udCounterCtrl, channel, 3, comValueTab[tabIndex % 2]);
   }
}
