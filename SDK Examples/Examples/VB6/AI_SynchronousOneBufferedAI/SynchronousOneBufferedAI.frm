...
Begin VB.Form SynchronousOneBufferedAI 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Synchronous One Buffered AI"
   ClientHeight    =   8025
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11400
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SynchronousOneBufferedAI.frx":0000
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin BDaqOcxLibCtl.BufferedAiCtrl BufferedAiCtrl1 
      Left            =   480
      OleObjectBlob   =   "SynchronousOneBufferedAI.frx":02F3
      Top             =   6960
   End
   ...
   Begin VB.Image Image1 
      Height          =   8040
      Left            =   0
      Picture         =   "SynchronousOneBufferedAI.frx":045C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11340
   End
End
Attribute VB_Name = "SynchronousOneBufferedAI"
...
Private Sub HandleError(ByVal err As BDaqOcxLibCtl.ErrorCode)
    ...
    If err <> BDaqOcxLibCtl.ErrorCode.Success Then
       MsgBox "Sorry ! There are some errors happened, the error code is: " & errorMessage, , "SynchronousOneBufferedAI"
    End If
End Sub
...
Private Sub ConfigureGraph()
    ...
    Else
        trackBar_shift.Max = CLng(Fix(1000# * BufferedAiCtrl1.ScanChannel.Samples / BufferedAiCtrl1.ConvertClock.Rate))  'ms
        trackBar_shift.Min = 0
...
Private Sub button_getData_Click()
    ...
    err = BufferedAiCtrl1.RunOnce
    If err = Success Then
        'get data
        err = BufferedAiCtrl1.GetData(BufferedAiCtrl1.BufferCapacity, dataScaled)
    End If
...
Private Sub Form_Load()
    ...
    If Not BufferedAiCtrl1.Initialized Then
        MsgBox "Please select a device with DAQNavi wizard!", , "SynchronousOneBufferedAI"
        End
    End If
    ...
    SynchronousOneBufferedAI.Caption = "Synchronous One Buffered AI(" + devDesc + ")"
