...
Begin VB.Form DIInterrupt 
   ...
   Begin BDaqOcxLibCtl.InstantDiCtrl InstantDiCtrl1 
      Left            =   5520
      OleObjectBlob   =   "DIInterrupt.frx":0672
      Top             =   3480
   End
   Begin VB.Image Image1 
      Height          =   840
      Left            =   4800
      Picture         =   "DIInterrupt.frx":070B
      Top             =   0
      Width           =   1950
   End
End
Attribute VB_Name = "DIInterrupt"
...
Private Sub InitListView()
    ...
    listViewForData.ColumnHeaders.Add , , " INT channel", 100
    Dim text As String
...
Private Sub HandleError(ByVal err As ErrorCode)
    ...
    If err <> Success Then
        MsgBox "Sorry ! There're some errors happened, the error code is: " & errorMessage, , "DI_Interrupt"
    End If
End Sub
...
Private Sub Form_Load()
    ...
    If Not InstantDiCtrl1.Initialized Then
        MsgBox "Please select a device with DAQNavi wizard!", , "DIInterrupt"
        End
    End If
    ...
    DIInterrupt.Caption = "DI Interrupt(" + devDesc + ")"
...
Private Sub InstantDiCtrl1_Interrupt(ByVal SrcNum As Long, PortData() As Byte)
    ...
    listViewForData.ListItems(listViewForData.ListItems.Count).ListSubItems(1).text = "        " + Str(SrcNum)
