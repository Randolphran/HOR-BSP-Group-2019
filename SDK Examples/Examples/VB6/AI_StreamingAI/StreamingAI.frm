...
Begin VB.Form StreamingAI 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Streaming AI"
   ClientHeight    =   7665
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11520
   ...
   Begin BDaqOcxLibCtl.BufferedAiCtrl BufferedAiCtrl1 
      Left            =   240
      OleObjectBlob   =   "StreamingAI.frx":02F3
      Top             =   6360
   End
   ...
   Begin VB.Image Image1 
      Height          =   7680
      Left            =   0
      Picture         =   "StreamingAI.frx":045C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11460
   End
End
Attribute VB_Name = "StreamingAI"
...
Private Sub HandleError(ByVal err As BDaqOcxLibCtl.ErrorCode)
    ...
    If err <> BDaqOcxLibCtl.ErrorCode.Success Then
       MsgBox "Sorry ! There are some errors happened, the error code is: " & errorMessage, , "StreamingAI"
    End If
End Sub
...
Private Sub Form_Load()
    ...
    If Not BufferedAiCtrl1.Initialized Then
        MsgBox "Please select a device with DAQNavi wizard!", , "StreamingAI"
        End
    End If
    ...
    StreamingAI.Caption = "Streaming AI(" + devDesc + ")"
