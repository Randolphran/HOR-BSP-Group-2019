...
Begin VB.Form DIStatusChangeInterrupt 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "DI Status Change Interrupt"
   ClientHeight    =   4185
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6540
   ...
   Begin AniGIFCtrl.AniGIF ExecutionStatus 
      ...
      HTTPPassword    =   ""
      MousePointer    =   0
      GIF             =   "DIStatusChangeInterrupt.frx":0000
      ExtendWidth     =   661
      ExtendHeight    =   661
      Loop            =   0
      AutoRewind      =   0   'False
   ...
   Begin BDaqOcxLibCtl.InstantDiCtrl InstantDiCtrl1 
      Left            =   6000
      OleObjectBlob   =   "DIStatusChangeInterrupt.frx":0672
      Top             =   3240
   End
   Begin VB.Image Image1 
      Height          =   1800
      Left            =   4440
      Picture         =   "DIStatusChangeInterrupt.frx":070B
      Top             =   -240
      Width           =   2325
   End
End
Attribute VB_Name = "DIStatusChangeInterrupt"
...
Private changedNum As Integer

Private Sub InitListView()
    'add the columnHeaders for every column
    listViewForData.ColumnHeaders.Add , , , 0
    listViewForData.ColumnHeaders.Add , , " Changed No#", 100
    Dim text As String
...
Private Sub HandleError(ByVal err As ErrorCode)
    ...
    If err <> Success Then
        MsgBox "Sorry ! There're some errors happened, the error code is: " & errorMessage, , "DIStatusChangeInterrupt"
    End If
End Sub
...
Private Sub Form_Load()
    ...
    If Not InstantDiCtrl1.Initialized Then
        MsgBox "Please select a device with DAQNavi wizard!", , "DI_StatusChange"
        End
    End If
    ...
    DIStatusChangeInterrupt.Caption = "DI Status Change Interrupt(" + devDesc + ")"
...
Private Sub InstantDiCtrl1_ChangeOfState(ByVal SrcNum As Long, PortData() As Byte)
    ...
    listViewForData.ListItems(listViewForData.ListItems.Count).ListSubItems(1).text = "        " + Str(changedNum)
