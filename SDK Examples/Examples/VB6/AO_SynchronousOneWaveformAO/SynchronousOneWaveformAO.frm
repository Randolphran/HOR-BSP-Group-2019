...
Begin VB.Form SynchronousOneWaveformAO 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Synchronous One Waveform AO"
   ClientHeight    =   6570
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5250
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SynchronousOneWaveformAO.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SynchronousOneWaveformAO.frx":1D3A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SynchronousOneWaveformAO.frx":3B3C
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SynchronousOneWaveformAO.frx":5A06
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SynchronousOneWaveformAO.frx":7C18
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SynchronousOneWaveformAO.frx":9AB2
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.CheckBox checkBox_triangleB 
      Height          =   750
      Left            =   3480
      Picture         =   "SynchronousOneWaveformAO.frx":B9E4
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4680
      Width           =   750
   ...
   Begin VB.CheckBox checkBox_squareB 
      Height          =   750
      Left            =   2280
      Picture         =   "SynchronousOneWaveformAO.frx":D89E
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   4680
      Width           =   750
   ...
   Begin VB.CheckBox checkBox_sineB 
      Height          =   750
      Left            =   1080
      Picture         =   "SynchronousOneWaveformAO.frx":F690
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   4680
      Width           =   750
   ...
   Begin VB.CheckBox checkBox_triangleA 
      Height          =   750
      Left            =   3480
      Picture         =   "SynchronousOneWaveformAO.frx":113BA
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   1920
      Width           =   750
   ...
   Begin VB.CheckBox checkBox_squareA 
      Height          =   750
      Left            =   2280
      Picture         =   "SynchronousOneWaveformAO.frx":13274
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   1920
      Width           =   750
   ...
   Begin VB.CheckBox checkBox_sineA 
      Height          =   750
      Left            =   1080
      Picture         =   "SynchronousOneWaveformAO.frx":15066
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   1920
      Width           =   750
   ...
   Begin BDaqOcxLibCtl.BufferedAoCtrl BufferedAoCtrl1 
      Left            =   360
      OleObjectBlob   =   "SynchronousOneWaveformAO.frx":16D90
      Top             =   5640
   End
   ...
   Begin VB.Image Image1 
      Height          =   6615
      Left            =   0
      Picture         =   "SynchronousOneWaveformAO.frx":16E78
      Stretch         =   -1  'True
      Top             =   0
      Width           =   5415
   End
End
Attribute VB_Name = "SynchronousOneWaveformAO"
...
Private Sub checkBox_triangleA_Click()
 ...
 Private Sub Form_Load()
    ...
    SynchronousOneWaveformAO.Caption = "Synchronous One Waveform AO(" + devDesc + ")"
