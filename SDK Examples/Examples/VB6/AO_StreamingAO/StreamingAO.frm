...
Begin VB.Form StreamingAO 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Streaming AO"
   ClientHeight    =   6570
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5250
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "StreamingAO.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "StreamingAO.frx":1D3A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "StreamingAO.frx":3B3C
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "StreamingAO.frx":5A06
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "StreamingAO.frx":7C18
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "StreamingAO.frx":9AB2
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin BDaqOcxLibCtl.BufferedAoCtrl BufferedAoCtrl1 
      Left            =   360
      OleObjectBlob   =   "StreamingAO.frx":16D90
      Top             =   5760
   End
   ...
   Begin VB.Image Image1 
      Height          =   6615
      Left            =   0
      Picture         =   "StreamingAO.frx":16E78
      Stretch         =   -1  'True
      Top             =   0
      Width           =   5415
   End
End
Attribute VB_Name = "StreamingAO"
...
Private Sub BufferedAoCtrl1_Stopped(ByVal Offset As Long, ByVal Count As Long)
    MsgBox "EvtBufferedAOStopped"
End Sub

Private Sub BufferedAoCtrl1_Underrun(ByVal Offset As Long, ByVal Count As Long)
    MsgBox "EvtBufferedAOUnderrun"
End Sub

Private Sub button_start_Click()
    If button_start.Caption = "Start" Then
        ...
        textBox_highLevelA.Enabled = False
        textBox_highLevelB.Enabled = False
        textBox_lowLevelA.Enabled = False
        textBox_lowLevelB.Enabled = False
        
        checkBox_sineA.Enabled = False
        checkBox_squareA.Enabled = False
        checkBox_triangleA.Enabled = False
        checkBox_sineB.Enabled = False
        checkBox_squareB.Enabled = False
        checkBox_triangleB.Enabled = False
    Else
        button_start.Caption = "Start"
        err = BufferedAoCtrl1.Stop(0)
        CheckError (err)
        
        textBox_highLevelA.Enabled = True
        textBox_highLevelB.Enabled = True
        textBox_lowLevelA.Enabled = True
        textBox_lowLevelB.Enabled = True
        
        checkBox_sineA.Enabled = True
        checkBox_squareA.Enabled = True
        checkBox_triangleA.Enabled = True
        checkBox_sineB.Enabled = True
        checkBox_squareB.Enabled = True
        checkBox_triangleB.Enabled = True
...
Private Sub Form_Load()
    ...
    StreamingAO.Caption = "Streaming AO(" + devDesc + ")"
