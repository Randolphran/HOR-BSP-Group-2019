...
Begin VB.Form AsynOneBufferedAI_TDtrtp 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Asynchronous One Buffered AI with Trigger Delay to Start and Delay to Stop"
   ClientHeight    =   8340
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11400
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "AsynOneBufferedAI_TDtrtp.frx":0000
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin BDaqOcxLibCtl.BufferedAiCtrl BufferedAiCtrl1 
      Left            =   600
      OleObjectBlob   =   "AsynOneBufferedAI_TDtrtp.frx":02F3
      Top             =   7560
   End
   ...
   Begin VB.Image triggerPointFlag 
      Height          =   330
      Left            =   720
      Picture         =   "AsynOneBufferedAI_TDtrtp.frx":045C
      Top             =   5760
      Width           =   195
   End
   ...
   Begin VB.Image Image1 
      Height          =   8640
      Left            =   0
      Picture         =   "AsynOneBufferedAI_TDtrtp.frx":09FE
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11340
   End
End
Attribute VB_Name = "AsynOneBufferedAI_TDtrtp"
...
Private Sub HandleError(ByVal err As BDaqOcxLibCtl.ErrorCode)
    ...
    If err <> BDaqOcxLibCtl.ErrorCode.Success Then
       MsgBox "Sorry ! There are some errors happened, the error code is: " & errorMessage, , "AsynOneBufferedAI_TDtrtp"
    End If
End Sub
...
Private Sub BufferedAiCtrl1_Stopped(ByVal Offset As Long, ByVal Count As Long)
    ...
    If BufferedAiCtrl1.Features.Trigger1Supported Then
        ...
        delayCount = BufferedAiCtrl1.Trigger1.delayCount
        Dim rate As Double
        rate = BufferedAiCtrl1.ConvertClock.rate
        ...
        Dim relativeWidth As Long
        relativeWidth = GetArrowXCordLocation(dataReadyCount / BufferedAiCtrl1.ScanChannel.ChannelCount, BufferedAiCtrl1.Trigger1.delayCount, Picture1.Width)
        
        triggerPointFlag.Visible = False
        label_triggerPoint.Visible = False
        triggerPointFlag.Left = 48
        label_triggerPoint.Left = 64
        If Not (BufferedAiCtrl1.Trigger1.Source = SignalNone) Then
            If relativeWidth = 0 Then
                triggerPointFlag.Visible = False
                label_triggerPoint.Visible = False
            Else
...
Private Sub Form_Load()
    ...
    If Not BufferedAiCtrl1.Initialized Then
        MsgBox "Please select a device in control property!", , "AsynOneBufferedAI_TDtrtp"
        End
    End If
    ...
    AsynOneBufferedAI_TDtrtp.Caption = "Asynchronous One Buffered AI with Trigger Delay to Start and Dealy to Stop(" + devDesc + ")"
    ...
    If Not (BufferedAiCtrl1.Features.TriggerSupported And BufferedAiCtrl1.Features.Trigger1Supported) Then
     MsgBox "the device does not support double trigger for Delay to Strat and Dealy to Stop!", , "AsynOneBufferedAI_TDtrtp"
        End
    End If
    ...
    If BufferedAiCtrl1.Features.Trigger1Supported Then
        BufferedAiCtrl1.Trigger1.Action = DelayToStop
        If Not BufferedAiCtrl1.Trigger1.Source = SignalNone Then
        triggerPointFlag.Visible = True
        label_triggerPoint.Visible = True
        End If
...
Private Sub trackBar_div_Scroll()
    ...
    If BufferedAiCtrl1.Features.TriggerSupported And Not (BufferedAiCtrl1.Trigger1.Source = SignalNone) Then
        triggerPointFlag.Visible = False
        label_triggerPoint.Visible = False
        triggerPointFlag.Left = 48
        label_triggerPoint.Left = 64
        SetTriggerPointFlagLoacation (BufferedAiCtrl1.Trigger1.delayCount)
    End If
End Sub
