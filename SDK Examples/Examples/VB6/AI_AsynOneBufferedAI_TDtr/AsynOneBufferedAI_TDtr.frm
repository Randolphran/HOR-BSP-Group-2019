...
Begin VB.Form AsynOneBufferedAI_TDtr 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Asynchronous One Buffered AI with Trigger Delay to Start"
   ClientHeight    =   8025
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11400
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "AsynOneBufferedAI_TDtr.frx":0000
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin BDaqOcxLibCtl.BufferedAiCtrl BufferedAiCtrl1 
      Left            =   720
      OleObjectBlob   =   "AsynOneBufferedAI_TDtr.frx":02F3
      Top             =   7440
   End
   ...
   Begin VB.Image Image1 
      Height          =   8040
      Left            =   0
      Picture         =   "AsynOneBufferedAI_TDtr.frx":045C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11340
   End
End
Attribute VB_Name = "AsynOneBufferedAI_TDtr"
...
Private Sub HandleError(ByVal err As BDaqOcxLibCtl.ErrorCode)
    ...
    If err <> BDaqOcxLibCtl.ErrorCode.Success Then
       MsgBox "Sorry ! There are some errors happened, the error code is: " & errorMessage, , "AsynOneBufferedAI_TDtr"
    End If
End Sub
...
Private Sub Form_Load()
    ...
    If Not BufferedAiCtrl1.Initialized Then
        MsgBox "Please select a device in control property!", , "AsynOneBufferedAI_TDtr"
        End
    End If
    ...
    AsynOneBufferedAI_TDtr.Caption = "Asynchronous One Buffered AI with Trigger Delay to Start(" + devDesc + ")"
