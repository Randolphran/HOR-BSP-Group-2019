...
BEGIN_MESSAGE_MAP(CConfigurationDlg, CDialog)
   ...
   //}}AFX_MSG_MAP
	ON_EN_CHANGE(IDC_ConvertClockRatePerChannel, OnEnChangeConvertclockrateperchannel)
...
void CConfigurationDlg::OnEnChangeConvertclockrateperchannel()
{
...
void CConfigurationDlg::OnBnClickedCancel()
{
   ...
   if (!windowText.Compare(_T("AsynchronousOneWaveformAO")))
   {
