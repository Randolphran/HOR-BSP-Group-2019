...
BOOL CStreamingAIDlg::OnInitDialog()
{
   ...
   //m_edit_level.SetWindowText(L"5");
   //m_edit_delayCount.SetWindowText(L"1000");
...
void CStreamingAIDlg::ConfigurateDevice()
{
   ...
   CString str ;
   str.Format(_T("Streaming AI with Trigger Delay to Start- Run( %s )"),WCHAR_TO_TCHAR((LPCWSTR)devInfo.Description,des));
   SetWindowText(str);
