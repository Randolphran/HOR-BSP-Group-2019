...
BOOL CConfigurationDlg::OnInitDialog()
{
   ...
   Array<DeviceTreeNode>* sptedDevices = pwMeterCtrl->getSupportedDevices();
...
void CConfigurationDlg::OnCbnSelchangeComboDevice()
{
   ...
   ErrorCode errorCode = pwMeterCtrl->setSelectedDevice(devInfo);
...
void CConfigurationDlg::OnBnClickedCancel()
{
   ...
   if (!windowText.Compare(_T("Counter_PulseWidthMeasurement")))
   {
