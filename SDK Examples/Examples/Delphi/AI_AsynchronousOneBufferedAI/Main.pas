...
begin
   ...
   begin
      MessageBox(self.WindowHandle, 'Please select a device with DAQNavi wizard!', 'AsynchronousOneBufferedAI', MB_OK or MB_ICONERROR);
   ...
   self.Caption := 'Asynchronous One Buffered AI(' + devDesc + ')';
