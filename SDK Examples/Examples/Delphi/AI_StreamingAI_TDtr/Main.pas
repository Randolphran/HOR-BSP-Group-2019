...
begin
   ...
   begin
      MessageBox(self.WindowHandle, 'Please select a device with DAQNavi wizard!', 'StreamingAI_TDtr', MB_OK or MB_ICONERROR);
   ...
   self.Caption := 'Streaming AI with Trigger Delay to Start(' + devDesc + ')';
...
procedure TMainForm.BufferedAiCtrl1CacheOverflow(Sender: TObject;
  Offset: Integer; Count: Integer);
begin
   MessageBox(0, 'BufferedAiCacheOverflow', 'StreamingAI_TDtr', MB_OK or MB_ICONERROR);
end;
...
begin
   ...
   begin
      MessageBox(0, 'BufferedAiOverrun', 'StreamingAI_TDtr', MB_OK or MB_ICONERROR);
