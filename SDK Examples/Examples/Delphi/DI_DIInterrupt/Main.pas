...
uses
  ...
  Dialogs, jpeg, ExtCtrls, ComCtrls, StdCtrls, GIFImage, OleCtrls,
  BDaqOcxLib_TLB;
...
type
  TMainForm = class(TForm)
    ...
    procedure InstantDiCtrl1Interrupt(Sender: TObject; SrcNum: Integer;
...
begin
   ...
   begin
      MessageBox(self.WindowHandle, 'Please select a device with DAQNavi wizard!', 'DIInterrupt', MB_OK or MB_ICONERROR);
   ...
   self.Caption := 'DI Interrupt(' + devDesc + ')';
...
procedure TMainForm.InstantDiCtrl1Interrupt(Sender: TObject;
