...
type
  TMainForm = class(TForm)
    ...
    procedure BufferedAoCtrl1Stopped(Sender: TObject; Offset,
      Count: Integer);
    procedure BufferedAoCtrl1Underrun(Sender: TObject; Offset,
      Count: Integer);
...
begin
   ...
   begin
      MessageBox(self.WindowHandle, 'Please select a device with DAQNavi wizard!', 'StreamingAO', MB_OK or MB_ICONERROR);
   ...
   self.Caption := 'Streaming AO(' + devDesc + ')'; 
...
procedure TMainForm.BufferedAoCtrl1Stopped(Sender: TObject; Offset,
  Count: Integer);
begin
   MessageBox(self.WindowHandle, 'EvtBufferedAOStopped!', 'StreamingAO', MB_OK or MB_ICONERROR);
end;

procedure TMainForm.BufferedAoCtrl1Underrun(Sender: TObject; Offset,
  Count: Integer);
begin
   MessageBox(self.WindowHandle, 'EvtBufferedAOUnderrun!', 'StreamingAO', MB_OK or MB_ICONERROR);
end;
...
begin
   ...
   begin
      ...
      begin
         MessageBox(self.WindowHandle, 'Please select a waveform!', 'StreamingAO', MB_OK or MB_ICONERROR);
         exit;
      end;
      ...
      txtboxHiLevelA.Enabled := false;
      txtboxHiLevelB.Enabled := false;
      txtboxLoLevelA.Enabled := false;
      txtboxLoLevelB.Enabled := false;
   ...
   begin
      ...
      txtboxHiLevelA.Enabled := true;
      txtboxHiLevelB.Enabled := true;
      txtboxLoLevelA.Enabled := true;
      txtboxLoLevelB.Enabled := true;
