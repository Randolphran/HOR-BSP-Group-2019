...
begin
   ...
   begin
      MessageBox(self.WindowHandle, 'Please select a device with DAQNavi wizard!', 'AsynchronousOneWaveformAO', MB_OK or MB_ICONERROR);
   ...
   self.Caption := 'Asynchronous One Waveform AO(' + devDesc + ')'; 
...
begin
   ...
   begin
      MessageBox(self.WindowHandle, 'Please select a waveform!', 'AsynchronousOneWaveformAO', MB_OK or MB_ICONERROR);
      exit;
   end;
