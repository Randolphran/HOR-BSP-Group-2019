...
type
  TMainForm = class(TForm)
    ...
    procedure InstantDiCtrl1ChangeOfState(Sender: TObject; SrcNum: Integer;
...
begin
   ...
   begin
      MessageBox(self.WindowHandle, 'Please select a device with DAQNavi wizard!', 'DIStatusChange', MB_OK or MB_ICONERROR);
   ...
   self.Caption := 'DI Status Change Interrupt(' + devDesc + ')';
...
procedure TMainForm.InstantDiCtrl1ChangeOfState(Sender: TObject;
...
begin
   ...
   item.Caption := '         ' + IntToStr(changedNum);
