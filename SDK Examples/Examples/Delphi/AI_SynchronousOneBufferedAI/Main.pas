...
begin
   ...
   begin
      MessageBox(self.WindowHandle, 'Please select a device with DAQNavi wizard!', 'SynchronousOneBufferedAI', MB_OK or MB_ICONERROR);
   ...
   self.Caption := 'Synchronous One Buffered AI(' + devDesc + ')';
