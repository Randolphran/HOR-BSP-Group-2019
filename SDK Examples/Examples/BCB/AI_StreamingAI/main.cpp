...
void TMainForm::Initialization() {
        ...
        AnsiString caption = "Streaming AI - Run("  + deviceName + ")";
        ...
        dataCount = channelCount * sectionLength;
...
//-----------------------------------------------------------------------------
void BDAQCALL TMainForm::OnOverrunEvent(void * sender, BfdAiEventArgs * args, void * userParam)
{
        TMainForm * uParam = (TMainForm *)userParam;
        MessageBox(uParam->WindowHandle, "BufferedAiOverrun!", "StreamingAI", MB_ICONERROR);
}
//-----------------------------------------------------------------------------
 void BDAQCALL TMainForm::OnCacheOverflowEvent(void * sender, BfdAiEventArgs * args, void * userParam)
 {
        TMainForm * uParam = (TMainForm *)userParam;
