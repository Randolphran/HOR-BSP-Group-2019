      ...
      static void Main(string[] args)
      {
         ...
         try
         {
            ...
            eventCounterCtrl.SelectedDevice = new DeviceInformation(deviceDescription);
				errorCode = eventCounterCtrl.LoadProfile(profilePath);//Loads a profile to initialize the device.
            ...
            eventCounterCtrl.ChannelStart = channelStart;
            ...
            Console.WriteLine(" EventCounter is in progress...\nconnect the input signal to");
            Console.WriteLine(" CNT#_CLK pin if you choose external clock!\n");
            Console.WriteLine(" any key to quit!\n\n");
            while (!Console.KeyAvailable)
            {
               Thread.Sleep(1000);
               int[] buffer = { 0 };
               eventCounterCtrl.Read(1, buffer);
               Console.WriteLine(" channel {0} Current Event counts  :{1}\n", channelStart, buffer[0]);
            }
