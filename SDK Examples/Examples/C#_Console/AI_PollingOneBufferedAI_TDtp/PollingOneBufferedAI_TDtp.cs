...
*
* Windows Example:
*    PollingOneBufferedAI_TDtp.cs
*
* Example Category:
*    AI
*
* Description:
*    This example demonstrates how to use Polling One Buffered AI with Delay to Stop Trigger function.
*
...
namespace PollingOneBufferedAI_TDtp
{
   class PollingOneBufferedAI_TDtp
   {
      ...
      static void Main(string[] args)
      {
         ...
         try
         {
            ...
            // Step 7: GetData with Polling Style
				...
				int triggerPointIndex = 0;
				if (triggerUsed == 0)
				{
					triggerPointIndex = returnedCount / channelCount - waveformAiCtrl.Trigger.DelayCount;
				}
				else if (triggerUsed == 1)
				{
					triggerPointIndex = returnedCount / channelCount - waveformAiCtrl.Trigger1.DelayCount;
				}
