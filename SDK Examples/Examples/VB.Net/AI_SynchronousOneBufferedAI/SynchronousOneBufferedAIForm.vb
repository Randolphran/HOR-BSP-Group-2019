...
Public Class SynchronousOneBufferedAIForm
    Inherits Form
#Region "fields"
...
#End Region
	...
	Private Sub SynchronousOneBufferedAIForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
		'The default device of project is demo device, users can choose other devices according to their needs.
		If Not WaveformAiCtrl1.Initialized Then
			MessageBox.Show("Please select a device in control property!", "SynchronousOneBufferedAI")
			Me.Close()
			Return
		End If
		...
		Me.Text = "Synchronous One Buffered AI - Run(" + WaveformAiCtrl1.SelectedDevice.Description + ")"
    ...
    Private Sub HandleError(ByVal err As ErrorCode)
		If err <> ErrorCode.Success Then
			MessageBox.Show("Sorry ! Some errors happened, the error code is: " & err.ToString(), "SynchronousOneBufferedAI")
		End If
    End Sub
    ...
    Private Sub button_getData_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button_getData.Click
		...
		Dim chanCount As Integer = WaveformAiCtrl1.Conversion.ChannelCount
		Dim sectionLength As Integer = WaveformAiCtrl1.Record.SectionLength
		Dim realCount As Integer = chanCount * sectionLength
		Dim returnValue As Integer
		ConfigureGraph()
		If err = ErrorCode.Success Then
			err = WaveformAiCtrl1.Start()
			If err = ErrorCode.Success Then
				err = WaveformAiCtrl1.GetData(realCount, m_dataScaled, -1, returnValue)
			End If
		End If
    ...
    Private Sub InitListView()
		...
		m_firstItem.Font = New Font("Microsoft Sans Serif", 10)

		m_secondItem = New ListViewItem()
		m_secondItem.SubItems.Clear()
		m_secondItem.UseItemStyleForSubItems = False
		m_secondItem.Font = New Font("Microsoft Sans Serif", 10)
		...
		For i As Integer = 1 To 7
			If i < WaveformAiCtrl1.Conversion.ChannelCount Then
				m_firstItem.SubItems.Add((""), Color.Black, Color.Honeydew, New Font("Microsoft Sans Serif", 10))
		...
		For i As Integer = 9 To 15
			If i < WaveformAiCtrl1.Conversion.ChannelCount Then
				m_secondItem.SubItems.Add((""), Color.Black, Color.Honeydew, New Font("Microsoft Sans Serif", 10))
