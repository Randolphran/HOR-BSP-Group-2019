...
Public Class DIInterruptForm
    Inherits Form
    Protected Delegate Sub UpdateListview(ByVal diIntChan As Integer, ByVal portValue As Byte())
    ...
    Private Sub DIInterruptForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        'The default device of project is demo device, users can choose other devices according to their needs.
        If Not InstantDiCtrl1.Initialized Then
            MessageBox.Show("Please select a device in control property!", "DIInterrupt")
            Me.Close()
            Return
        End If

      Me.Text = "DI Interrupt - Run(" + InstantDiCtrl1.SelectedDevice.Description
        Me.Text += ")"
    ...
    Protected Sub UpdateListviewMethod(ByVal diIntChan As Integer, ByVal portData As Byte())
    ...
    Private Sub HandleError(ByVal err As ErrorCode)
        If err <> ErrorCode.Success Then
            MessageBox.Show("Sorry ! There're some errors happened, the error code is: " & err.ToString(), "DI_Interrupt")
        End If
    End Sub
End Class
