...
Public Class DIPatternMatchInterruptForm
    ...
    Private Sub DIPatternMatchInterruptForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        'The default device of project is demo device, users can choose other devices according to their needs.
        If Not InstantDiCtrl1.Initialized Then
            MessageBox.Show("Please select a device in control property!", "DI_PatternMatch")
            Me.Close()
            Return
        End If

      Me.Text = "DI Pattern Match Interrupt - Run(" + InstantDiCtrl1.SelectedDevice.Description + ")"
        ...
        If InstantDiCtrl1.Features.PortCount > 10 Then
            PortsData.Width = 210 + 22 * (InstantDiCtrl1.Features.PortCount - 10)
    ...
    Private Sub InstantDiCtrl1_DiPmIntPortX(ByVal src As Object, ByVal args As DiSnapEventArgs) Handles InstantDiCtrl1.PatternMatch
        Try
    ...
    Private Sub UpdateListviewMethod(ByVal portNum As Integer, ByVal portData As Byte())
        ...
        listViewForData.Items(listViewForData.Items.Count - 1).SubItems(0).Tag = System.Math.Max(System.Threading.Interlocked.Increment(m_matchedNum), m_matchedNum - 1)
    ...
    Private Sub HandleError(ByVal err As ErrorCode)
        If err <> ErrorCode.Success Then
            MessageBox.Show("Sorry ! Some errors happened, the error code is: " & err.ToString(), "DIPatternMatchInterrupt")
        End If
    End Sub
End Class
