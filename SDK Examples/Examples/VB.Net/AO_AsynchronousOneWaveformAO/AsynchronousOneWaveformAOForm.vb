...
Partial Public Class AsynchronousOneWaveformAOForm
    Inherits Form
#Region "fileds"
    ...
    Dim formCloseFlag As Boolean = False
...
#End Region
    ...
    Private Sub AsynchronousOneWaveformAOForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
      ...
      Me.Text = "Asynchronous One Waveform AO - Run(" & description & ")"
    ...
    Private Sub m_BufferedAoCtrl_Stopped(ByVal sender As Object, ByVal e As BfdAoEventArgs) Handles m_bufferedAoCtrl.Stopped
        If Not formCloseFlag Then
            Invoke(New UpdateUIDelegate(AddressOf updateControl))
        End If
    End Sub

    Private Sub AsyncOneWaveOutAoForm_FormClosed(ByVal sender As Object, ByVal e As FormClosedEventArgs) Handles MyBase.FormClosed
        formCloseFlag = True
    End Sub
