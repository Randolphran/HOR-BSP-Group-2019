...
Partial Public Class StreamingAOForm
    Inherits Form
#Region "fileds"
    ...
    Private m_waveSelectCheckBox As CheckBox()
...
#End Region
    ...
    Private Sub StreamingAOForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        m_BufferedAoCtrl.Streaming = True ' specify the running mode: streaming-buffered
      ...
      Me.Text = "Streaming AO - Run(" & description & ")"
    ...
    Private Sub m_BufferedAoCtrl_Underrun(ByVal sender As Object, ByVal e As BfdAoEventArgs) Handles m_BufferedAoCtrl.Underrun
        '  MessageBox.Show("EvtBufferedAOUnderrun");
    End Sub

    Private Sub m_BufferedAoCtrl_Stopped(ByVal sender As Object, ByVal e As BfdAoEventArgs) Handles m_BufferedAoCtrl.Stopped
        MessageBox.Show("EvtBufferedAOStopped")
    End Sub
End Class