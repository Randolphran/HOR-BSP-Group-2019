...
Public Class StreamingAIwithTriggerForm
    Inherits Form
#Region "fields"
...
#End Region
    ...
    Private Sub StreamingAIForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
		...
		Me.Text = "Streaming AI with Trigger Delay to Start - Run(" + WaveformAiCtrl1.SelectedDevice.Description + ")"
	...
	Private Sub waveformAiCtrl1_Overrun(ByVal sender As Object, ByVal args As BfdAiEventArgs) Handles WaveformAiCtrl1.MarkOverrun
